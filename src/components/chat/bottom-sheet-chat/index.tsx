...
import {
  ...
  setBottomChatOpen,
} from '../../../store/redux/slices/wide-app/chat';
...
const BottomSheetChat = () => {
  ...
  const handleMessage = message => {
    ...
    return <Styled.MessageContent selectable>{message}</Styled.MessageContent>;
  };
        ...
        <Styled.ContainerItem>
          ...
          <Styled.Card>
            <Styled.MessageTopContainer>
              <Styled.MessageAuthor selectable>
                {item.senderName}
