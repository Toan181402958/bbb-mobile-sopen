...
import {useTracks, isTrackReference, RoomContext} from '@livekit/react-native';
import {Track} from 'livekit-client';
import Styled from './styles';
import {liveKitRoom} from '../../../services/livekit';

const LiveKitCameraView = ({trackName, isGrid, renderPlaceholder}) => {
...
const LiveKitCameraViewContainer = ({cameraId, isGrid, renderPlaceholder}) => {
  return (
