...
const Item = styled.View`
  ...
  ${({dimensionHeight, isPresentationOpen}) =>
    dimensionHeight && // 1 user
    isPresentationOpen &&
    `
    height: ${parseInt((dimensionHeight * 2) / 3, 10)}px;
  `}

  ${({dimensionHeight, usersCount, isPresentationOpen}) =>
    dimensionHeight && // 2 user
    isPresentationOpen &&
    usersCount === 2 &&
    `
  ...
  ${({usersCount, dimensionHeight, isPresentationOpen}) =>
    usersCount % 2 === 0 &&
    isPresentationOpen &&
    usersCount > 2 &&
    `
...
const RenderSessionAlone = ({
  ...
  return (
    <ContainerTextSessionAlone isPresentationOpen={isPresentationOpen}>
      ...
      />
      <NoPollsLabelTitle>{sessionAloneTitle}</NoPollsLabelTitle>
      <NoPollsLabelSubtitle>{sessionAloneDesc}</NoPollsLabelSubtitle>
