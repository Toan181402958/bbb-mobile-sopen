...
import AudioManager from '../../services/webrtc/audio-manager.ts';
import VideoManager from '../../services/webrtc/video-manager.tsx';
import {disconnectLiveKitRoom} from '../../services/livekit/index.ts';
import ScreenWrapper from '../../components/screen-wrapper/index.tsx';
import UtilsService from '../../utils/functions/index.ts';
import Styled from './styles.tsx';
import ExpandedCard from '../../components/expandable-card/index.tsx';
...
import {setMainRoomBlockedByBreakout} from '../../store/redux/slices/wide-app/client.ts';
            ...
            <>
              ...
              <Styled.ParticipantsContainer>
                ...
                <Styled.ParticipantsCount>
                  {`${item.participants.length} ${t(
                    'mobileSdk.breakout.participantsLabel',
                  )}`}
                </Styled.ParticipantsCount>
              </Styled.ParticipantsContainer>
            </>
