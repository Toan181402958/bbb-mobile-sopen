...
import {SET_ROLE, SET_PRESENTER} from '../../graphql/mutations/userList';
  ...
  const renderItem = ({item}) => {
    ...
    return (
      <Styled.CardPressable
        onPress={e => onIconPress(e, item, isMe)}
        isMe={isMe}>
        <Styled.UserAvatar
          userName={item.name}
          userRole={item.role}
    ...
    <>
      <Pressable
        ...
        <Styled.GuestMenuContainer>
          ...
          <Styled.GuestPolicyIcon icon="arrow-right" iconColor={Colors.white} />
        </Styled.GuestMenuContainer>
      </Pressable>
      {pendingUsers?.length > 0 && (
        <Pressable
          ...
          <Styled.GuestMenuContainer>
            ...
            />
            <Styled.GuestPolicyText>
              {t('mobileSdk.userList.waitingAtendees')}
            </Styled.GuestPolicyText>
